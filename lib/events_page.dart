                        ...
                        child: Container(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              Text('02.07.2023',style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                              Padding(padding: EdgeInsets.only(top: 5)),
                              Text('15.000 / 15.000 ₽',style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                        ],)],)))),                   
                        ...
                        child: Container(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              Padding(padding: EdgeInsets.only(top: 5)),
                              Text('13.08.2023',style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                              Padding(padding: EdgeInsets.only(top: 5)),
                              Text('12.500 / 25.000 ₽',style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                        ],)],)))),                   
