...
class GeneralEvents extends StatelessWidget {
            ...
            Expanded(
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Text('Мероприятия', style: TextStyle(color: Color(0xffADADAD), fontSize: 40, fontWeight: FontWeight.w100),)
            ],
          ),),)
        ],),
            ...
            Container(
              padding: EdgeInsets.only(top: 30),
                child: Column(
                  children: 
                  [
                    Text('Общие мероприятия с \nВасильев Павел',   textAlign: TextAlign.center, style: TextStyle(color: Color(0xffADADAD), fontSize: 32, fontWeight: FontWeight.w100),),
                      ...
                      Expanded( 
                        child: Container(
                          ...
                          children: [
                            ...
                            Image(image: AssetImage('image/event_foto_example.png'), width: 64, height: 64,),
                            Padding(padding: EdgeInsets.only(left: 215),),
                            Column(
                              children: [
                              Text('Корпоратив',style: TextStyle(color: Color(0xffADADAD), fontSize: 24, fontWeight: FontWeight.w100)),
                              Row(children: [
                                Padding(padding: EdgeInsets.only(left: 5)),
                                Padding(padding: EdgeInsets.only(top: 5)),
                                Text('02.07.2023', textAlign: TextAlign.right,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),],),
                              Row(children: [
                                Padding(padding: EdgeInsets.only(left: 5)),
                                Padding(padding: EdgeInsets.only(top: 15)),
                                Text('15.500 / 15.000 ₽', textAlign: TextAlign.right ,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                              ],)  
                        ],)],)))),                   

                      Padding(padding: EdgeInsets.only(top: 10)), 

                    ElevatedButton(onPressed: () {_navigateToEventPage(context);}, style: ElevatedButton.styleFrom(fixedSize: Size(double.infinity, 85), backgroundColor: Color(0xff4E4E4E),shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(0), )),child: 
                      Expanded( 
                        child: Container(
                          color: Color(0xff4E4E4E),
                          child: Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                              Text('День рождения Нач..',style: TextStyle(color: Color(0xffADADAD), fontSize: 24, fontWeight: FontWeight.w100)),
                              Padding(padding: EdgeInsets.only(top: 5)),
                              Row(children: [
                        ...
                        child: Container(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                              Text('Отпуск',style: TextStyle(color: Color(0xffADADAD), fontSize: 24, fontWeight: FontWeight.w100)),
                              Row(children: [
                                Padding(padding: EdgeInsets.only(top: 5)),
                                Text('13.08.2023', textAlign: TextAlign.right,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),],),
                              Row(children: [
                                Padding(padding: EdgeInsets.only(top: 15)),
                                Text('12.500 / 25.000 ₽', textAlign: TextAlign.right ,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                              ],)  
                        ],)],)))),                   
