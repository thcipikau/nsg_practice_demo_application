...
class PursharePaidPage extends StatelessWidget {
          ...
          children: [
            Container(
                child: Column(
                  children: 
                  [
                    Text('Магазин: Окей',   textAlign: TextAlign.center, style: TextStyle(color: Color(0xffADADAD), fontSize: 32, fontWeight: FontWeight.w100),),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              Row(children: [
                                ...
                                Text('7.500 / 7.500 ₽', textAlign: TextAlign.right,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),],),
                              Row(children: [
                                Padding(padding: EdgeInsets.only(left: 5)),
                                Padding(padding: EdgeInsets.only(top: 15)),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              Row(children: [
                                Padding(padding: EdgeInsets.only(left: 5)),
                                Padding(padding: EdgeInsets.only(top: 15)),
                                Text('Корпоратив', textAlign: TextAlign.right ,style: TextStyle(color: Color(0xffADADAD), fontSize: 14, fontWeight: FontWeight.w100)),
                              ],)  
                        ],),],)))),                   
